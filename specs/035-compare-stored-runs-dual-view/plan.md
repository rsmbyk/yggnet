...
Deliver ITEM-035 (Compare stored runs dual view) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-035.
