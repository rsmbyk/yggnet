...
Deliver ITEM-012 (Algo compare) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-012.
...
- Branch: `feat/SPEC-012-short-slug`
- PR target: `develop`
- Expected bump: **minor**
