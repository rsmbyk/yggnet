# Tasks 047: Shared tags + Tags tool
...
- [x] Branch from the current base (`feat/047-shared-tags`)
- [x] Red — domain/app tests: `src/lib/graph/tags.test.ts`, filter/ops updates
- [x] Green — domain + Tags tool + world focus + TagPicker + Nodes optgroups
- [x] Red — E2E: `e2e/tags-tool.e2e.ts` (+ Nodes optgroups)
- [x] Green — E2E
