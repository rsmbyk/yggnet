...
Deliver ITEM-038 (Save/load named docs + palette find) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-038.
...
- Branch: `feat/SPEC-038-named-save-palette-find`
- PR target: `develop`
- Expected bump: **minor**
