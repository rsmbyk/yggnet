...
Deliver ITEM-004 (World graph render) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-004.
...
- Branch: `feat/SPEC-004-short-slug`
- PR target: `develop`
- Expected bump: **minor**
