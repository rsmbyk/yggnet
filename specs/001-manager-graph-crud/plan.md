...
Deliver ITEM-001 (Manager graph CRUD) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-001.
...
- Branch: `feat/SPEC-001-short-slug`
- PR target: `develop`
- Expected bump: **minor**
