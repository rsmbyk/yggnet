...
Deliver ITEM-007 (Directions guided travel) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-007.
...
- Branch: `feat/SPEC-007-short-slug`
- PR target: `develop`
- Expected bump: **minor**
