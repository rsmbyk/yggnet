...
Deliver ITEM-005 (Selection sync) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-005.
...
- Branch: `feat/SPEC-005-short-slug`
- PR target: `develop`
- Expected bump: **minor**
