...
Deliver ITEM-024 (Undo / redo) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-024.
...
- Branch: `feat/SPEC-024-short-slug`
- PR target: `develop`
- Expected bump: **minor**
