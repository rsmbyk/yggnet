...
Deliver ITEM-018 (Diff two nodes) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-018.
...
- Branch: `feat/SPEC-018-short-slug`
- PR target: `develop`
- Expected bump: **minor**
