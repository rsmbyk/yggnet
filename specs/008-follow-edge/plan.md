...
Deliver ITEM-008 (Follow edge) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-008.
...
- Branch: `feat/SPEC-008-short-slug`
- PR target: `develop`
- Expected bump: **patch**
