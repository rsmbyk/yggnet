...
Deliver ITEM-020 (Minimap) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-020.
...
- Branch: `feat/SPEC-020-short-slug`
- PR target: `develop`
- Expected bump: **minor**
