...
Deliver ITEM-015 (Pin / anchor nodes) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-015.
...
- Branch: `feat/SPEC-015-short-slug`
- PR target: `develop`
- Expected bump: **patch**
