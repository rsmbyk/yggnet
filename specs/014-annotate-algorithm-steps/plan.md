...
Deliver ITEM-014 (Annotate algorithm steps) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-014.
...
- Branch: `feat/SPEC-014-short-slug`
- PR target: `develop`
- Expected bump: **patch**
