...
Deliver ITEM-003 (Explore bird's-eye camera) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-003.
...
- Branch: `feat/SPEC-003-short-slug`
- PR target: `develop`
- Expected bump: **minor**
