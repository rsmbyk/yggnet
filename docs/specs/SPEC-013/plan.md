...
Deliver ITEM-013 (Compare runs) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-013.
...
- Branch: `feat/SPEC-013-short-slug`
- PR target: `develop`
- Expected bump: **minor**
