...
Deliver ITEM-036 (Step annotations readback + playback) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-036.
...
- Branch: `feat/SPEC-036-annotate-playback`
- PR target: `develop`
- Expected bump: **minor**
