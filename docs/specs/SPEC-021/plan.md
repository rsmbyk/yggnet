...
Deliver ITEM-021 (Save / load graph) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-021.
...
- Branch: `feat/SPEC-021-short-slug`
- PR target: `develop`
- Expected bump: **minor**
