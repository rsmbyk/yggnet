...
Deliver ITEM-009 (Algorithm registry + picker) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-009.
...
- Branch: `feat/SPEC-009-short-slug`
- PR target: `develop`
- Expected bump: **minor**
