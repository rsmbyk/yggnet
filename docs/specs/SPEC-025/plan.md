...
Deliver ITEM-025 (Command palette) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-025.
...
- Branch: `feat/SPEC-025-short-slug`
- PR target: `develop`
- Expected bump: **minor**
