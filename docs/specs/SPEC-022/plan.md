...
Deliver ITEM-022 (Autosave) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-022.
...
- Branch: `feat/SPEC-022-short-slug`
- PR target: `develop`
- Expected bump: **patch**
