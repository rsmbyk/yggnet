...
Deliver ITEM-017 (Filters by type/tag) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-017.
...
- Branch: `feat/SPEC-017-short-slug`
- PR target: `develop`
- Expected bump: **minor**
