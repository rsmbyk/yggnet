...
Deliver ITEM-019 (LOD labels) end-to-end: domain first (TDD), then session/UI/world adapters, then Playwright.
...
- Cover the main happy path described in acceptance criteria for ITEM-019.
...
- Branch: `feat/SPEC-019-short-slug`
- PR target: `develop`
- Expected bump: **patch**
